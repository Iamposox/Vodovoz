...
namespace Vodovoz.Filters.GtkViews
{
    ...
    public partial class CarFilterView : FilterViewBase<CarJournalFilterViewModel>
    {
        ...
        private void Configure()
        {
            ...
            ycheckIncludeArchive.Binding.AddBinding(ViewModel, vm => vm.CanChangeIsArchive, w => w.Sensitive).InitializeFromSource();
            ...
            yenumcomboRaskat.Binding.AddBinding(ViewModel, vm => vm.CanChangeRaskat, w => w.Sensitive).InitializeFromSource();

            yenumcomboVisitingMaster.ItemsEnum = typeof(AllYesNo);
            yenumcomboVisitingMaster.Binding.AddBinding(ViewModel, vm => vm.VisitingMasters, w => w.SelectedItem).InitializeFromSource();
            ...
            enumcheckCarTypeOfUse.Binding.AddBinding(ViewModel, vm => vm.CanChangeRestrictedCarTypesOfUse, w => w.Sensitive)
                .InitializeFromSource();
