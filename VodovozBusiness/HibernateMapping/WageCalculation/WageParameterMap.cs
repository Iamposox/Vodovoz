...
namespace Vodovoz.HibernateMapping.WageCalculation
{
	...
	public class EmployeeWageParameterMap : SubclassMap<EmployeeWageParameter>
	{
		public EmployeeWageParameterMap()
		{
			...
			References(x => x.WageParameterItem).Column("wage_parameter_item_id");
			References(x => x.DriverWithOurCarsWageParameterItem).Column("driver_with_our_cars_wage_parameter_item_id");
		}
	}
}
